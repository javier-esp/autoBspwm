...
```shell
git clone https://github.com/javier-esp/autoBspwm.git
cd autoBspwm
```
...
4. Execute the script without sudo.

```shell
./install.sh
```

5. Reboot your system and select bspwm.

## Overview of the environment
![overview1](/assets/view1.png "view1")

![overview2](/assets/view2.png "view2")

![overview3](/assets/view3.png "view3")

![overview4](/assets/view4.png "view4")
...
- **Fonts**: [hack](https://github.com/ryanoasis/nerd-fonts/tree/master/patched-fonts/Hack)
